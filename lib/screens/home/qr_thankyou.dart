...
class QRThankYou extends StatefulWidget {
  @override
  _ORThankYouState createState() => _ORThankYouState();
}

class _ORThankYouState extends State<QRThankYou> with TickerProviderStateMixin{
  BuildContext _ctx;
  ...
  void navigationPage() async {
    Navigator.of(context).pushNamedAndRemoveUntil('/wallet', (Route<dynamic> route) => false);
  }
          ...
          Container(
            child: Column(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment.center,
                  child: Text("QR code scanned successfully.",style: GoogleFonts.lato(fontSize: 20,color: Color(0xff33691E),fontWeight: FontWeight.w600),),
                ),
                Align(
                  alignment: Alignment.center,

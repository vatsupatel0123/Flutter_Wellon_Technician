...
class LeadCompleteScreen extends StatefulWidget {
  @override
  _LeadCompleteScreenState createState() => _LeadCompleteScreenState();
}

class _LeadCompleteScreenState extends State<LeadCompleteScreen> {
  BuildContext _ctx;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Complete Lead",style: GoogleFonts.lato(color:Colors.white,letterSpacing: 1,fontWeight: FontWeight.w700),),

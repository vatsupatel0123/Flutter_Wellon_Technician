...
class _ShopScreenState extends State<ShopScreen> {
  ...
  initState() {
    ...
    _loadPref();
    //Timer(Duration(milliseconds: 100),_loadPref1);
  }
                                  ...
                                  children: [
                                    Stack(children:[
                                      ...
                                      data.cat_image.toString()!=""?Padding(
                                        ...
                                        child: Container(height:90,width: 90,child: ClipRRect(child: Image.network(RestDatasource.BASE_URL+"categoryimages/"+data.cat_image),)),
                                      ):Container(),
                                    ]),
                                    Padding(

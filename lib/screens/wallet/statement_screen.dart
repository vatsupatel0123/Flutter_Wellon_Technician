             ...
             if(_isLoading==false)
               {
                 ...
                 (total_balance!="0")?
                 reportView(context):Fluttertoast.showToast(msg: "Insufficient Balance",backgroundColor: Colors.green,fontSize: 18);
               }
           },
         ),
       ],
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Text("Withdraw Money", style: GoogleFonts.lato(color:Colors.green.shade600,fontSize: 14,letterSpacing: 1,fontWeight: FontWeight.w700),),
                              ),
                            ),
                          ),
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Text("Your Request", style: GoogleFonts.lato(color:Colors.blue.shade600,fontSize: 14,letterSpacing: 1,fontWeight: FontWeight.w700),),
                              ),
                            ),
                          ),
                        ],
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Text("Your Request", style: GoogleFonts.lato(color:Colors.blue.shade600,fontSize: 15,letterSpacing: 1,fontWeight: FontWeight.w700),),
                              ),
                            ),
                          ),
                        ],
          ...
          RefreshIndicator(
            ...
            child: FutureBuilder<List<WalletHistoryList>>(
              ...
              return Stack(
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 10,top: 187),

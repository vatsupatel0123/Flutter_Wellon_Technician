...
class AddPaymentScreen extends StatefulWidget {
  String spid,amount;
  AddPaymentScreen(this.spid,this.amount);
              ...
              child: WebView(
                ...
                onWebViewCreated: (controller) {
                  ...
                  _webController.loadUrl(
                      "${RestDatasource.BASE_URL}paymentgatewayaddmoney/${widget.spid}/${widget.amount}");
                },
                onPageFinished: (page) {
                  if (page.contains("/addmoneypaymentfailed")) {
                    Navigator.push(
                      context,
                      PageTransition(
                        duration: Duration(milliseconds: 500),
                  ...
                  if (page.contains("/addmoneyThanks")){
                      Navigator.push(
                        context,
                        PageTransition(
                          duration: Duration(milliseconds: 500),

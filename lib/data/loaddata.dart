...
class LoadData with ChangeNotifier{
  ...
  static String total_credit_ledger,total_debit_ledger,total_balance_ledger,total_credit_normal,
  total_debit_normal,total_balance_normal,total_pending,total_process,total_complete,total_cancel;
